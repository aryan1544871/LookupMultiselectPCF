...
export class LMS implements ComponentFramework.ReactControl<IInputs, IOutputs> {
  ...
  public updateView(
    ...
    const props: ILookupMultiSel = {
      ...
      isReadOnly: context.mode.isControlDisabled

    };
    return React.createElement(LookupMultiSel, props);
  }

  private onChange = (selectedValue: string[]) => {
